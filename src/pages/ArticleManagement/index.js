...
const AllArticles = () => {
  ...
  const handleEditOk = (values) => {
    const formData = new FormData();
    if (fileUpload) {
      formData.append("article_media", fileUpload)
    }
    ...
    <>
      <div className='patients-search'>
        ...
        <div className='btn-list'>
          <Button type="primary" htmlType="submit" onClick={showAddModal}> Add</Button>
        </div>
      </div>
        ...
        <div className='funder-detail'>
          <ul>
            ...
            <li>
              ...
              <textarea className='right' cols={50} rows={3} value={articleId?.description} disabled />
            </li>
            <br />
            ...
            <div className='post-detail'>
              <div className='footer-post'>
                ...
                {articleId?.comment === 0 ?
                  ...
                  :
                  <span className='comment' onClick={() => navigate(`/article-management/all-article/${articleId?.id}/article-comment`)} ><CommentIcon />{articleId?.comment} Comments</span>
                }
              </div>
            </div>
