...
import { getIndustriesList, deleteIndustries, addIndustries, getIndustriesInfo, patchIndustries, } from '../../actions/AppDataManagement/IndustriesActiion';
...
const ManageIndustries = () => {
  ...
  const viewIndustry = () => {
    dispatch(getIndustriesList())
      .then((response) => {
        setInitialIndustry(response?.data)
