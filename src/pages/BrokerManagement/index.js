    ...
    },
    {
      ...
      render: (row, record) =>
        <Space>
          ...
          />
          <Button className='action-btn'
            icon={record.is_verified === true ? < CheckCircleOutlined style={{ color: '#D79600' }} /> : <CloseCircleOutlined style={{ color: '#666666' }} />}
    ...
    <>
      <div className='patients-search'>
        ...
        <div className='btn-list'>
          <Button type="primary" htmlType="submit" onClick={() => navigate('/new-broker-request')}> New Broker Request</Button>
        </div>
      </div>
      ...
      >
        <div className='funder-detail'>
          <div className='modal-image'>
            <img src={userId?.profile_img ? userId.profile_img : toAbsoluteUrl('/images/user-img.svg')} alt="" title={userId?.profile_img ? "" : "not found"} />
          </div>
          <ul>
            <li>
            ...
            <li>
              ...
              <span className='right'>{formatPhoneNumber(userId?.phone_number)}</span>
            </li>
            <li>
            ...
            <li>
              ...
              <span className='right'>{moment(userId?.dob).format('MM/DD/YYYY') || "Date of birth not found"}</span>
            </li>
            <li>
              <span className='left'>Company name</span>
              <span className='right'>{userId?.company_name || "Company name not found"}</span>
            </li>
            <li>
            ...
            <li>
              ...
              <span className='right'>
                {userId?.exp_value} {" "}
                {userId?.exp_type === "MO" && userId?.exp_value > 1 ? "Months" : userId?.exp_type === "MO" && userId?.exp_value === 1 ? 'Month' : userId?.exp_type === "YR" && userId?.exp_value > 1 ? 'Years' : 'Year'}
              </span>
            </li>
            <li>
