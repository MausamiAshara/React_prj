				...
				<div className='funder-detail'>
					...
					<ul>
						...
						<li>
							...
							<span className='right'>{userId?.state || "State not found"}</span>
						</li>
						<li>
						...
						<li>
							...
							<span className='right'>{userId?.position || "Position not found"}</span>
						</li>
						<li>
							<span className='left'>Experience</span>
							<span className='right'>{userId?.exp_value} {" "}
